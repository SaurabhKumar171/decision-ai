          ...
          >
            <div className="max-w-6xl mx-auto px-4 py-6 relative flex flex-col items-center">
              ...
              <h2 className="text-xl md:text-2xl font-bold tracking-tight mb-4 text-center">
                Stop Suffering From Decision Fatigue.
              </h2>

              <div className="flex flex-col md:flex-row gap-4 w-full max-w-4xl justify-center mb-5">
                {/* Left Comparison Badge */}
                <div className="flex-1 rounded-xl border border-red-500/20 bg-red-500/5 p-4 flex gap-3 shadow-sm">
                  <div className="mt-0.5 text-red-500">❌</div>
                  <div>
                    <h3 className="font-semibold text-sm mb-1 text-foreground/90">
                      Google & Chatbots
                    </h3>
                    <p className="text-xs text-muted-foreground leading-relaxed">
                      Return 50 options, endless tabs, and leaves you stuck in
                      analysis paralysis.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex-1 rounded-xl border border-emerald-500/30 bg-emerald-500/10 p-4 flex gap-3 shadow-md relative overflow-hidden group">
                  ...
                  <div className="mt-0.5 text-emerald-500 relative z-10">
                    ⚡
                  </div>
                  <div className="relative z-10">
                    <h3 className="font-semibold text-sm mb-1 text-emerald-700 dark:text-emerald-400">
                      DecisionMind AI
                    </h3>
                    <p className="text-xs text-muted-foreground leading-relaxed">
                      Analyzes your constraints, picks{" "}
                      <strong className="font-bold text-foreground">ONE</strong>{" "}
                      optimal path, and fetches live execution resources.
                    </p>
                  </div>
                </div>
              </div>
              ...
              {/* Micro Explainer */}
              <div className="flex items-center gap-2 text-xs font-medium text-muted-foreground bg-background/50 px-4 py-2 rounded-full border border-border/40">
                <Lightbulb className="w-3.5 h-3.5 text-amber-500" />
                <span>
                  <span className="hidden sm:inline">How it works: </span>Define
                  situation <ArrowRight className="inline w-3 h-3 mx-0.5" /> AI
                  evaluates <ArrowRight className="inline w-3 h-3 mx-0.5" /> Get
                  1 clear decision + real links
                </span>
              </div>
            </div>
          </motion.div>
